...
|    2 |`events/event.cpp`                    | `Event::trigger()`                     | Missed case: what if the EventHandler is null?                           |✅| 
...
|   58 |`types/vector.hpp`                   | `*`          | Check Vector functionalities                          |✅|
|   59 |`types/hash_map.hpp`                   | `*`          | Check HashMap functionalities                          |✅|
